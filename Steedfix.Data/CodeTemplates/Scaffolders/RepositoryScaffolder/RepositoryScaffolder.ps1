...
if (!$NoChildItems) {
	$dbContextScaffolderResult = Scaffold DbContextScaffolder -ModelType $ModelType -DbContextType $DbContextType -Area $Area -Project $Project -CodeLanguage $CodeLanguage
...
$interfaceNamespace =  $defaultNamespace + ".Interfaces"
...
Scaffold RepositoryInterfaceScaffolder -ModelType $ModelType -Project $Project -CodeLanguage $CodeLanguage